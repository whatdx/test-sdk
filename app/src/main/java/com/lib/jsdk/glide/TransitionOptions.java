...
import com.lib.jsdk.glide.request.transition.NoTransition;
import com.lib.jsdk.glide.request.transition.TransitionFactory;
import com.lib.jsdk.glide.request.transition.ViewAnimationFactory;
import com.lib.jsdk.glide.request.transition.ViewPropertyAnimationFactory;
import com.lib.jsdk.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.lib.jsdk.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link com.lib.jsdk.glide.request.transition.Transition} for each request started with these
