...
import com.lib.jsdk.glide.load.data.InputStreamRewinder;
...
import com.lib.jsdk.glide.load.engine.prefill.BitmapPreFiller;
import com.lib.jsdk.glide.load.engine.prefill.PreFillType;
import com.lib.jsdk.glide.load.model.AssetUriLoader;
import com.lib.jsdk.glide.load.model.ByteArrayLoader;
import com.lib.jsdk.glide.load.model.ByteBufferEncoder;
import com.lib.jsdk.glide.load.model.ByteBufferFileLoader;
import com.lib.jsdk.glide.load.model.DataUrlLoader;
import com.lib.jsdk.glide.load.model.FileLoader;
import com.lib.jsdk.glide.load.model.GlideUrl;
import com.lib.jsdk.glide.load.model.MediaStoreFileLoader;
import com.lib.jsdk.glide.load.model.ResourceLoader;
import com.lib.jsdk.glide.load.model.StreamEncoder;
import com.lib.jsdk.glide.load.model.StringLoader;
import com.lib.jsdk.glide.load.model.UnitModelLoader;
import com.lib.jsdk.glide.load.model.UriLoader;
import com.lib.jsdk.glide.load.model.UrlUriLoader;
import com.lib.jsdk.glide.load.model.stream.HttpGlideUrlLoader;
import com.lib.jsdk.glide.load.model.stream.HttpUriLoader;
import com.lib.jsdk.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.lib.jsdk.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.lib.jsdk.glide.load.model.stream.UrlLoader;
import com.lib.jsdk.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.lib.jsdk.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.lib.jsdk.glide.load.resource.bitmap.BitmapEncoder;
import com.lib.jsdk.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.lib.jsdk.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.lib.jsdk.glide.load.resource.bitmap.Downsampler;
import com.lib.jsdk.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.lib.jsdk.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.lib.jsdk.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.lib.jsdk.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.lib.jsdk.glide.load.resource.bitmap.VideoDecoder;
import com.lib.jsdk.glide.load.resource.bytes.ByteBufferRewinder;
import com.lib.jsdk.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.lib.jsdk.glide.load.resource.drawable.UnitDrawableDecoder;
import com.lib.jsdk.glide.load.resource.file.FileDecoder;
import com.lib.jsdk.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.lib.jsdk.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.lib.jsdk.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.lib.jsdk.glide.manager.ConnectivityMonitorFactory;
import com.lib.jsdk.glide.manager.RequestManagerRetriever;
import com.lib.jsdk.glide.module.ManifestParser;
import com.lib.jsdk.glide.request.RequestListener;
import com.lib.jsdk.glide.request.RequestOptions;
import com.lib.jsdk.glide.request.target.ImageViewTargetFactory;
 ...
 * {@link com.lib.jsdk.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
    ...
    private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
        ...
        List<com.lib.jsdk.glide.module.GlideModule> manifestModules = Collections.emptyList();
        ...
        if (annotationGeneratedModule != null
            ...
            Iterator<com.lib.jsdk.glide.module.GlideModule> iterator = manifestModules.iterator();
            while (iterator.hasNext()) {
                com.lib.jsdk.glide.module.GlideModule current = iterator.next();
        ...
        if (Log.isLoggable(TAG, Log.DEBUG)) {
            for (com.lib.jsdk.glide.module.GlideModule glideModule : manifestModules) {
        ...
        for (com.lib.jsdk.glide.module.GlideModule module : manifestModules) {
        ...
        try {
            Class<GeneratedAppGlideModule> clazz =
                    (Class<GeneratedAppGlideModule>)
                            Class.forName("com.lib.jsdk.glide.GeneratedAppGlideModuleImpl");
     ...
     * {@link com.lib.jsdk.glide.load.Transformation}s. Use outside of these classes is not generally
     * recommended. </p>
     */
    @NonNull
