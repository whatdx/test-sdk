...
/**
 * A request that loads a resource for an {@link com.lib.jsdk.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link com.lib.jsdk.glide.request.target.Target}s (for example). Using a similar but different
