...
/**
 * An {@link com.lib.jsdk.glide.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link com.lib.jsdk.glide.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
