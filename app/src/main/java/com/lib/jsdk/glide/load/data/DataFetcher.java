package com.lib.jsdk.glide.load.data;
 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.lib.jsdk.glide.load.model.ModelLoader}. {@link
 * #loadData(Priority, com.lib.jsdk.glide.load.data.DataFetcher.DataCallback)}
 ...
 * com.lib.jsdk.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * com.lib.jsdk.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.lib.jsdk.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.lib.jsdk.glide.load.DataSource} this fetcher will return data from.
   */
  @NonNull
