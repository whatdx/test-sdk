 ...
 * com.lib.jsdk.glide.load.engine.Resource} interface.
 *
 * @param <Z> The type of data returned by the wrapped {@link com.lib.jsdk.glide.load.engine.Resource}.
 */
class EngineResource<Z> implements Resource<Z> {
  private final boolean isMemoryCacheable;
  private final boolean isRecyclable;
  private final com.lib.jsdk.glide.load.engine.Resource<Z> resource;
  ...
  EngineResource(
      com.lib.jsdk.glide.load.engine.Resource<Z> toWrap,
