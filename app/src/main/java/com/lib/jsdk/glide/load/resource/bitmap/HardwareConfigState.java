...
final class HardwareConfigState {
   ...
   * and/or a sufficiently large {@link com.lib.jsdk.glide.load.engine.cache.MemoryCache}, we can
  ...
  private synchronized boolean isFdSizeBelowHardwareLimit() {
    if (++decodesSinceLastFdCheck >= MINIMUM_DECODES_BETWEEN_FD_CHECKS) {
      ...
      if (!isHardwareConfigAllowed && Log.isLoggable(com.lib.jsdk.glide.load.resource.bitmap.Downsampler.TAG, Log.WARN)) {
