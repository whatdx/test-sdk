...
import com.lib.jsdk.glide.Registry.NoModelLoaderAvailableException;
...
/**
 * Capable of building an {@link com.lib.jsdk.glide.load.model.ModelLoader} that wraps one or more other {@link com.lib.jsdk.glide.load.model.ModelLoader}s for
...
public class MultiModelLoaderFactory {
  ...
  private static final com.lib.jsdk.glide.load.model.ModelLoader<Object, Object> EMPTY_MODEL_LOADER = new EmptyModelLoader();
  ...
  private <Model, Data> com.lib.jsdk.glide.load.model.ModelLoaderFactory<Model, Data> getFactory(@NonNull Entry<?, ?> entry) {
    return (com.lib.jsdk.glide.load.model.ModelLoaderFactory<Model, Data>) entry.factory;
  }

  @NonNull
  @SuppressWarnings("unchecked")
  private <Model, Data> com.lib.jsdk.glide.load.model.ModelLoader<Model, Data> build(@NonNull Entry<?, ?> entry) {
    return (com.lib.jsdk.glide.load.model.ModelLoader<Model, Data>) Preconditions.checkNotNull(entry.factory.build(this));
  }

  @NonNull
  @SuppressWarnings("unchecked")
  private static <Model, Data> com.lib.jsdk.glide.load.model.ModelLoader<Model, Data> emptyModelLoader() {
    return (com.lib.jsdk.glide.load.model.ModelLoader<Model, Data>) EMPTY_MODEL_LOADER;
  }
