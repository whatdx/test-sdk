...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.lib.jsdk.glide.load.data.DataFetcher} and the
   * {@link com.lib.jsdk.glide.load.EncodeStrategy} of the
   * {@link com.lib.jsdk.glide.load.ResourceEncoder} (if an
   * {@link com.lib.jsdk.glide.load.ResourceEncoder} is available).
   */
