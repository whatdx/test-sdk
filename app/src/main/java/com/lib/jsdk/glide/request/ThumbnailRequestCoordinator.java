...
/**
 * A coordinator that coordinates two individual {@link com.lib.jsdk.glide.request.Request}s that load a small thumbnail
 * version of an image and the full size version of the image at the same time.
 */
public class ThumbnailRequestCoordinator implements com.lib.jsdk.glide.request.RequestCoordinator,
        com.lib.jsdk.glide.request.Request {
  @Nullable
  private final com.lib.jsdk.glide.request.RequestCoordinator parent;

  private com.lib.jsdk.glide.request.Request full;
  private com.lib.jsdk.glide.request.Request thumb;
  ...
  public void setRequests(com.lib.jsdk.glide.request.Request full, com.lib.jsdk.glide.request.Request thumb) {
    this.full = full;
    this.thumb = thumb;
  }
  ...
  @Override
  public void onRequestFailed(com.lib.jsdk.glide.request.Request request) {
