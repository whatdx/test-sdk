...
/**
 * A resource that defers any calls to {@link com.lib.jsdk.glide.load.engine.Resource#recycle()} until after {@link #unlock()} is
 * called.
 *
 * <p>If the resource was recycled prior to {@link #unlock()}, then {@link #unlock()} will also
 * recycle the resource.
 */
final class LockedResource<Z> implements com.lib.jsdk.glide.load.engine.Resource<Z>,
  ...
  private com.lib.jsdk.glide.load.engine.Resource<Z> toWrap;
  private boolean isLocked;
  private boolean isRecycled;

  @SuppressWarnings("unchecked")
  @NonNull
  static <Z> LockedResource<Z> obtain(com.lib.jsdk.glide.load.engine.Resource<Z> resource) {
