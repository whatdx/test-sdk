 ...
 * {@link android.graphics.Bitmap}s returned by {@link com.lib.jsdk.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.lib.jsdk.glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.lib.jsdk.glide.load.ResourceDecoder}.
   ...
   * request, use {@link com.lib.jsdk.glide.request.RequestOptions#disallowHardwareConfig()}.
   *
