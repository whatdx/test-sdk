...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback,
  ...
  private void notifyComplete(com.lib.jsdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    setNotifiedOrThrow();
  ...
  private void decodeFromRetrievedData() {
    ...
    com.lib.jsdk.glide.load.engine.Resource<R> resource = null;
    try {
  ...
  private void notifyEncodeAndRelease(com.lib.jsdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    if (resource instanceof Initializable) {
      ((Initializable) resource).initialize();
    }

    com.lib.jsdk.glide.load.engine.Resource<R> result = resource;
  ...
  private <Data> com.lib.jsdk.glide.load.engine.Resource<R> decodeFromData(DataFetcher<?> fetcher, Data data,
    ...
    try {
      ...
      com.lib.jsdk.glide.load.engine.Resource<R> result = decodeFromFetcher(data, dataSource);
      if (Log.isLoggable(TAG, Log.VERBOSE)) {
  ...
  private <Data> com.lib.jsdk.glide.load.engine.Resource<R> decodeFromFetcher(Data data, DataSource dataSource)
  ...
  private <Data, ResourceType> com.lib.jsdk.glide.load.engine.Resource<R> runLoadPath(Data data, DataSource dataSource,
  ...
  @Synthetic
  @NonNull
  <Z> com.lib.jsdk.glide.load.engine.Resource<Z> onResourceDecoded(DataSource dataSource,
                                                                   @NonNull com.lib.jsdk.glide.load.engine.Resource<Z> decoded) {
    @SuppressWarnings("unchecked")
    Class<Z> resourceSubClass = (Class<Z>) decoded.get().getClass();
    Transformation<Z> appliedTransformation = null;
    com.lib.jsdk.glide.load.engine.Resource<Z> transformed = decoded;
    ...
    com.lib.jsdk.glide.load.engine.Resource<Z> result = transformed;
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.engine.Resource<Z> onResourceDecoded(@NonNull com.lib.jsdk.glide.load.engine.Resource<Z> decoded) {
