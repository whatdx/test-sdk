...
public interface DataRewinder<T> {
   ...
   * {@link com.lib.jsdk.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.lib.jsdk.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.lib.jsdk.glide.load.data.DataRewinder} wrapping the given data.
     */
    @NonNull
     ...
     * {@link com.lib.jsdk.glide.load.data.DataRewinder}s for.
     */
    @NonNull
