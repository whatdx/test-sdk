 ...
 */
public class ResourceLoader<Data> implements com.lib.jsdk.glide.load.model.ModelLoader<Integer, Data> {
  ...
  public ResourceLoader(Resources resources, com.lib.jsdk.glide.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Integer, InputStream> {
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<Integer, InputStream> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static class FileDescriptorFactory
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<Integer, ParcelFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static final class AssetFileDescriptorFactory
    ...
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<Integer, AssetFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
